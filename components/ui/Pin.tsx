    ...
    >
      {
        href != ""?
          <a
            href={href}
            target={"_blank"} >
              <LinkContent transform={transform} otherClassName={className} title={title} href={href}>
                {children}
              </LinkContent>
          </a>:
              <LinkContent transform={transform} otherClassName={className} title={title} href={href}>
...
export const LinkContent = ({transform, children, otherClassName, title, href}: {transform: string, children: ReactNode, otherClassName?: string, title?: string, href?: string}) => {
  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className={cn(" relative z-50 ", otherClassName)}>{children}</div>
        </div>
      </div>
